...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIReflectedV.Position = [606 427 300 185];
            ...
            app.UIincidentstrain.Position = [283 221 300 185];
            ...
            app.UIreflectedstrain.Position = [606 221 300 185];
            ...
            app.UItransmittedstrain.Position = [931 220 300 185];
            ...
            app.UIstressexp.Position = [283 14 300 185];
            ...
            app.UIstressstrainexp.Position = [606 13 300 185];
