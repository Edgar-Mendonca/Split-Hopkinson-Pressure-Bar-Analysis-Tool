...
%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function LoadDefaultsMenuSelected(app, event)
            ...
            app.CIncidentBar.Value = app.WaveSpeedExp.Value;
            app.CTransmittedBar.Value = app.WaveSpeedExp.Value;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIIncidentV.Position = [283 422 300 185];
            ...
            app.UIReflectedV.Position = [607 427 300 185];
            ...
            app.UITransmittedV.Position = [931 427 300 185];
            ...
            app.UIincidentstrain.Position = [283 216 300 185];
            ...
            app.UIreflectedstrain.Position = [606 216 300 185];
            ...
            app.UItransmittedstrain.Position = [931 212 300 185];
            ...
            app.UIstressexp.Position = [283 6 300 185];
            ...
            app.UIstressstrainexp.Position = [607 6 300 185];
            ...
            app.GraphAxesInputsPanel.Position = [10 461 230 145];
            ...
            app.STRAINCALCULATIONSPanel.Position = [9 219 231 221];
            ...
            app.STRESSCALCULATIONPanel.Position = [9 13 230 185];
            ...
            app.OUTPUTSPanel.Position = [17 125 260 213];
            ...
            app.OUTPUTSWAVEANALYSIS1Panel.Position = [15 36 269 205];
            ...
            app.Hyperlink.Position = [39 537 451 22];
            ...
            app.Hyperlink2.Position = [39 495 431 22];
            ...
            app.Hyperlink3.Position = [39 453 330 22];
            ...
            app.LINKSLabel.Position = [39 575 59 22];
            ...
            app.Hyperlink4.Position = [39 411 216 22];
