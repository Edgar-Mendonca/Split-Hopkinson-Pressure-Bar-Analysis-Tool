...
%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.OUTPUTSPanel.Position = [17 141 260 213];
            ...
            app.MaximumStressNmm2EditFieldLabel.Position = [34 127 128 22];
            ...
            app.MaximumStress.Position = [177 127 70 22];
            ...
            app.MaximumStrainRates1Label.Position = [29 94 131 22];
            ...
            app.MaximumStrainRate.Position = [177 94 70 22];
            ...
            app.MaximumStrainEditFieldLabel.Position = [79 160 83 22];
            ...
            app.MaximumStrain.Position = [178 160 70 22];
            ...
            app.MaxTrueStrainEditFieldLabel.Position = [80 61 80 22];
            ...
            app.MaxTrueStrain.Position = [178 61 70 22];
            ...
            app.MaxTrueStressNmm2EditFieldLabel.Position = [36 28 125 22];
            ...
            app.MaxTrueStress.Position = [176 28 70 22];

            % Create EDGARMENDONCALabel_2
            app.EDGARMENDONCALabel_2 = uilabel(app.TheoreticalResultsTab);
            app.EDGARMENDONCALabel_2.FontSize = 10;
            app.EDGARMENDONCALabel_2.FontWeight = 'bold';
            app.EDGARMENDONCALabel_2.Position = [4 1 116 22];
            app.EDGARMENDONCALabel_2.Text = '© EDGAR MENDONCA ';
            ...
            app.UIForceIB.Position = [295 437 300 185];
            ...
            app.UIForceTB.Position = [606 437 300 185];
            ...
            app.UIForce3Wave.Position = [917 437 300 185];
            ...
            app.UIVelocity1Wave.Position = [295 236 300 185];
            ...
            app.UIVelocity3Wave.Position = [606 236 300 185];
            ...
            app.UIVelocityAnalysis.Position = [917 236 300 185];
            ...
            app.UIDisplacement1Wave.Position = [295 29 300 185];
            ...
            app.UIDisplacement3Wave.Position = [606 29 300 185];
            ...
            app.UIDisplacementAnalysis.Position = [917 29 300 185];
            ...
            app.INPUTSWAVEANALYSISPanel.Position = [15 274 269 348];
            ...
            app.OUTPUTSWAVEANALYSIS1Panel.Position = [15 52 269 205];
            ...
            % Create EDGARMENDONCALabel_5
            app.EDGARMENDONCALabel_5 = uilabel(app.WaveAnalysis1Tab);
            app.EDGARMENDONCALabel_5.FontSize = 10;
            app.EDGARMENDONCALabel_5.FontWeight = 'bold';
            app.EDGARMENDONCALabel_5.Position = [1 1 116 22];
            app.EDGARMENDONCALabel_5.Text = '© EDGAR MENDONCA ';
            ...
            app.UIForceDisplacement.Position = [262 420 300 185];
            ...
            app.UICompressiveStressStrain.Position = [264 206 300 185];
            ...
            app.UICompressiveStrainRate.Position = [917 206 300 185];
            ...
            app.UITrueStressStrain3W.Position = [582 206 300 185];
            ...
            app.UICompressiveStressTime.Position = [589 420 300 185];
            ...
            app.UICompressiveStrainTime.Position = [917 411 300 185];
            ...
            app.OUTPUTSWAVEANALYSIS2Panel.Position = [10 397 241 210];
            ...
            app.OUTPUTSSTRAINRATESs1Panel.Position = [16 274 197 92];
            ...
            % Create EDGARMENDONCALabel_3
            app.EDGARMENDONCALabel_3 = uilabel(app.WaveAnalysis2Tab);
            app.EDGARMENDONCALabel_3.FontSize = 10;
            app.EDGARMENDONCALabel_3.FontWeight = 'bold';
            app.EDGARMENDONCALabel_3.Position = [4 1 116 22];
            app.EDGARMENDONCALabel_3.Text = '© EDGAR MENDONCA ';

            % Create DocumentationTab
            app.DocumentationTab = uitab(app.TabGroup);
            app.DocumentationTab.Title = 'Documentation';

            % Create Hyperlink
            app.Hyperlink = uihyperlink(app.DocumentationTab);
            app.Hyperlink.URL = 'https://sites.google.com/view/edgarmendonca/research/split-hopkinson-pressure-bar-design-testing-and-applications';
            app.Hyperlink.Position = [39 553 451 22];
            app.Hyperlink.Text = 'SPLIT HOPKINSON PRESSURE BAR-DESIGN, TESTING AND APPLICATIONS';

            % Create Hyperlink2
            app.Hyperlink2 = uihyperlink(app.DocumentationTab);
            app.Hyperlink2.URL = 'https://sites.google.com/view/edgarmendonca/projects/design-of-split-hopkinson-pressure-bar-experimental-setup';
            app.Hyperlink2.Position = [39 511 431 22];
            app.Hyperlink2.Text = 'DESIGN OF SPLIT HOPKINSON PRESSURE BAR EXPERIMENTAL SETUP';

            % Create Hyperlink3
            app.Hyperlink3 = uihyperlink(app.DocumentationTab);
            app.Hyperlink3.URL = 'https://sites.google.com/view/edgarmendonca/projects/multi-channel-dynamic-strain-gauge-amplifier';
            app.Hyperlink3.Position = [39 469 330 22];
            app.Hyperlink3.Text = 'MULTI CHANNEL DYNAMIC STRAIN GAUGE AMPLIFIER';

            % Create LINKSLabel
            app.LINKSLabel = uilabel(app.DocumentationTab);
            app.LINKSLabel.FontSize = 18;
            app.LINKSLabel.FontWeight = 'bold';
            app.LINKSLabel.Position = [39 591 59 22];
            app.LINKSLabel.Text = 'LINKS';

            % Create Hyperlink4
            app.Hyperlink4 = uihyperlink(app.DocumentationTab);
            app.Hyperlink4.URL = 'https://sites.google.com/view/edgarmendonca/projects/velocity-measurement-system';
            app.Hyperlink4.Position = [39 427 216 22];
            app.Hyperlink4.Text = 'VELOCITY MEASUREMENT SYSTEM';

            % Create EDGARMENDONCALabel_4
            app.EDGARMENDONCALabel_4 = uilabel(app.DocumentationTab);
            app.EDGARMENDONCALabel_4.FontSize = 10;
            app.EDGARMENDONCALabel_4.FontWeight = 'bold';
            app.EDGARMENDONCALabel_4.Position = [4 1 116 22];
            app.EDGARMENDONCALabel_4.Text = '© EDGAR MENDONCA ';
